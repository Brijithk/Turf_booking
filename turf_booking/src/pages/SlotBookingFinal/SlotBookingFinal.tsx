import './SlotBookingFinal.css'
import { useState, forwardRef } from 'react';
import DatePicker from 'react-datepicker';
import React from 'react';
import 'react-datepicker/dist/react-datepicker.css';
import BookCourt from "../../../public/BookCourt.png"
          ...
          <div className='slot-content'>
            <div className='slot-section1'>
              <div className='slot-item1 slot-common'>
                <img src={BookCourt} className='slot-img' />
                <h3>Book Court 1</h3>
                <div className='slot-location'>
                  <img src={location} className='slot-image' />
            ...
            <div className='slot-section2'>
              ...
              <div className='slot-layer2'>
                <div className='slot-layer2-common'>
                  <img src={schedule} className='slot-img1' />
                  <p>04am-</p>
                  <p>05am</p>
                </div>
                <div className='slot-layer2-common'>
